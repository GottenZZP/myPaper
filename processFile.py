...
class ProcessFile():
    ...
    def del_stop_word(self, file_path):
        stop_words = ["あっ","あり","ある","い","いう","いる","う","うち","お","および","おり","か","かつて","から","が","き","ここ","こと","この",\
            "これ","これら","さ","さらに","し","しかし","する","ず","せ","せる","そして","その","その他","その後","それ","それぞれ","た","ただし",\
                "たち","ため","たり","だ","だっ","つ","て","で","でき","できる","です","では","でも","と","という","といった","とき","ところ",\
                    "として","とともに","とも","と共に","な","ない","なお","なかっ","ながら","なく","なっ","など","なら","なり","なる","に",\
                        "において","における","について","にて","によって","により","による","に対して","に対する","に関する","の","ので","のみ",\
                            "は","ば","へ","ほか","ほとんど","ほど","ます","また","または","まで","も","もの","ものの","や","よう","より","ら",\
                                "られ","られる","れ","れる","を","ん","及び","特に"]
...
if __name__ == "__main__":
    ...
    # obj.del_stop_word("D:\\python_code\\paper\\data\\val2.csv")
    # mean_len, total_len = obj.read_Zh("D:\python_code\paper\corpus\chinese\wiki_zh", 35000)
    # print(mean_len, total_len)
    # mean_len = obj.split_sentence("D:\python_code\paper\corpus\chinese\chinese_total_data_35000.csv")
    # obj.split_train_val("D:\python_code\paper\corpus\chinese\split_data.csv", 0.2)
    # obj.split_train_test("D:\\python_code\\paper\\corpus\\chinese\\train.csv", 0.1)
    # obj.label_to_idx("D:\python_code\paper\corpus\chinese\chinese_idx_35000.csv", "D:\python_code\paper\corpus\chinese\\val.csv")
